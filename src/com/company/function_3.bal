 ...
 public function readCoreV1NamespacedEvent(string name, string namespace) returns http:Response | error {
    ...
    public function connectCoreV1OptionsNamespacedPodProxy(string name, string namespace) returns http:Response | error {
        ...
        // TODO: Update the request as needed
        var v = _connectCoreV1OptionsNamespacedPodProxyEp->options("/api/v1/namespaces/{namespace}/pods/{name}/proxy", message=request);
    return v;
 }
    ...
    public function connectCoreV1OptionsNamespacedPodProxyWithPath(string name, string namespace, string path) returns http:Response | error {
        ...
        // TODO: Update the request as needed
        var v = _connectCoreV1OptionsNamespacedPodProxyWithPathEp->options("/api/v1/namespaces/{namespace}/pods/{name}/proxy/{path}", message=request);
    return v;
 }
    ...
    public function connectCoreV1OptionsNamespacedServiceProxy(string name, string namespace) returns http:Response | error {
        ...
        // TODO: Update the request as needed
        var v = _connectCoreV1OptionsNamespacedServiceProxyEp->options("/api/v1/namespaces/{namespace}/services/{name}/proxy", message=request);
    return v;
 }
    ...
    public function connectCoreV1OptionsNamespacedServiceProxyWithPath(string name, string namespace, string path) returns http:Response | error {
        ...
        // TODO: Update the request as needed
        var v = _connectCoreV1OptionsNamespacedServiceProxyWithPathEp->options("/api/v1/namespaces/{namespace}/services/{name}/proxy/{path}", message=request);
    return v;
 }
